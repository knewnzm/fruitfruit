...
public class Review {
	...
	public Review(int review_num, String review_title, String review_content, String review_writer,
			Date review_date, int review_product_num, int review_like_hit) {
		super();
	...
	public String toString() {
		return "Review [review_num=" + review_num + ", review_title=" + review_title + ", review_content="
				+ review_content + ", review_writer=" + review_writer
				+ ", review_date=" + review_date + ", review_product_num=" + review_product_num 
				+ ", review_like_hit=" + review_like_hit + "]";
	}
